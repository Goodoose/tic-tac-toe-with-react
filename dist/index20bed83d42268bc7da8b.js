...
function (_React$Component) {
  ...
  function App() {
    ...
    _this.handleClickRestart = _this.handleClickRestart.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function handleClickRestart() {
    ...
    value: function isFull() {
      var stateGame = this.state.stateGame;
      return stateGame.every(function (cell) {
        return cell.name !== '';
      });
    }
  }, {
    key: "winCombo",
    value: function winCombo() {
      var winTemplates = ['012', '345', '678', '036', '147', '258', '048', '246'];
      var player = 'X';
      var changePlayer = this.state.changePlayer;
      ...
      var combo = '';
      var stateGame = this.state.stateGame;
      stateGame.forEach(function (cell) {
        if (cell.name === player) {
          combo += cell.id;
        }
      });
      ...
      for (var i = 0; i < winTemplates.length; i++) {
        var count = 0;

        for (var j = 0; j < winTemplates[i].length; j++) {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: messageWin && 'moved'
      }, messageWin), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "container shadow"
      }, renderGame), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        className: "button__restart",
        onClick: function onClick() {
          return _this3.handleClickRestart();
        }
      }, "Restart Game"));
    }
  }], [{
    ...
    value: function setStartState() {
      var QUANTITY_CELLS = 9;
      return _toConsumableArray(Array(QUANTITY_CELLS).keys()).map(function (item) {
        return {
          id: item,
          name: ''
        };
